...
async function main() {
  const accentureTrack = await db.track.create({
    data: {
      ...
      description:
        "Comprehensive track to prepare for Accenture recruitment process. Covers quantitative aptitude, logical reasoning, verbal ability, and coding.",
              ...
              create: [
                {
                  ...
                  type: "MCQ",
                  content:
                    "If A can do a piece of work in 10 days and B can do it in 15 days, how long will they take if they work together?",
                  data: JSON.stringify({
                ...
                },
                {
                  ...
                  type: "MCQ",
                  content:
                    "A train moving at 60 km/hr crosses a pole in 9 seconds. What is the length of the train?",
                  data: JSON.stringify({
  ...
  const tcsTrack = await db.track.create({
    data: {
      ...
      description:
        "Master the TCS NQT with puzzles, programming logic, and hands-on coding.",
      category: "Mass Hiring",
      isPublic: true,
      modules: {
        create: [
